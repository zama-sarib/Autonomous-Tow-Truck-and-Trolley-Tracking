...
threshold_depth_meters = 1.5  # Adjust this threshold value as needed in meters
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            depth_mask = depth_image[roi_top_left[1]:roi_bottom_right[1], roi_top_left[0]:roi_bottom_right[0]]
            stop_cmd = False
            if np.min(depth_mask) <= threshold_depth_meters:
                stop_cmd = True
                try:
