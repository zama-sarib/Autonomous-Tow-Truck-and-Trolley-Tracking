...
def process_detection(frame, outs):
    cv2.rectangle(frame,(40,20),(800,440),(0, 0, 255),2)
    ...
    for i in indices:
        ...
        x = int(left+width/2)
        y = int(top+ height/2)
        if left >= 40 and top >= 20 and left+width <= 440 and top+height <= 880:
...
if __name__ == "__main__":
    ...
    modelConfiguration = "yolov5.cfg"
    modelWeights = "yolov5.weights"
